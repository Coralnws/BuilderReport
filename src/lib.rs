// src/lib.rs
/*
 * Core library for BuilderReport
 */
...
#[derive(Debug)]
pub struct BuilderReportProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BuilderReportProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BuilderReport processing");
    
    let mut processor = BuilderReportProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BuilderReportProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BuilderReportProcessor::new(false);
